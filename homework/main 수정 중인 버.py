            ...
            if 0 < self.boardpos < 10:
                ...
                if 0 < self.houses < 4:
                    ...
                    for house in range(self.houses):
                        housePos = [colourPos[0] + 14 + count, 610]
                ...
                if 0 < self.houses < 4:
                    count = 1
                    for house in range(self.houses):
                        housePos = [71, colourPos[1] + 14 + count]
                ...
                if 0 < self.houses <4:
                    count = 1
                    for house in range(self.houses):
                        housePos = [colourPos[0] + 14 + count, 73]
                ...
                if 0 < self.houses < 4:
                    count = 1
                    for house in range(self.houses):
                        housePos = [608, colourPos[1] + 14 + count]
...
class AI: # There's an Eve object of the Player class and an AI object of the AI class. I like to think of 'Eve: Player' as Eve's body and 'AI: AI' as her brain.
    ...
    def develop(self, street): # Returns the next property she wants to build a house on.
        ...
        # if currentSquare.getCostOfHouse() <= self.player.money * 0.6 and currentSquare.houses < 4:
        #     buildingProp.houses += 1
        #     self.player.money -= buildingProp.getCostOfHouse()
        #     return buildingProp
        

        # underdevelopedCount = 0 # 원래 위에 꺼 써야 하는데 에러가 너무 많이 떠서 잠시 원래 버전인 이거 쓰는 중
        # buildingProp = None
                ...
                if type(currentSquare) == Property:
                    ...
                    if not currentSquare.paid:
                        ...
                        if currentSquare.name == 'Free Parking':
                            ...
                            alert = Alert('Serial doubles-roller', "넌 갇혀있따. Isn't it fun to gloat at #the people in jail")
                        currentSquare.paid = True
